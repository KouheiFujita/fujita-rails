...
class MycontactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mycontact" do
    assert_difference('Mycontact.count') do
      post mycontacts_url, params: { mycontact: { : @mycontact., age: @mycontact.age, mail: @mycontact.mail, name: @mycontact.name, nationality: @mycontact.nationality } }
    end
  ...
  test "should update mycontact" do
    patch mycontact_url(@mycontact), params: { mycontact: { : @mycontact., age: @mycontact.age, mail: @mycontact.mail, name: @mycontact.name, nationality: @mycontact.nationality } }
